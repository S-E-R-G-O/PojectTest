...
import cv2
import numpy as np
from ColorBGRplt import Colors
...
while True:
    ...
    if len(cntr) != 0:
        ...
        for cnt in cntr:
            ...
            if area > Tracking.detected_area and area > max_area * 0.85:
            ...
            for obj in tracking.objects:
                ...
                if _w > 50 and _h > 100:
                    try:
                        ...
                        # Outline
                        cv2.circle(frame_res, (22, 25), 20,  Colors.light_grey, 1)
                        # color in RGB
                        cv2.putText(frame_res, "TOP RGB: {} {} {}".format(r, g, b),
                                    (50, 30), 0, 0.5, Colors.white, 2)
                        ...
                        # Outline
                        cv2.circle(frame_res, (22, 65), 20, Colors.light_grey, 1)
                        # color in RGB
                        cv2.putText(frame_res, "BOT RGB: {} {} {}".format(r, g, b),
                                    (50, 70), 0, 0.5, Colors.white,  2)
                        ...
                        cv2.rectangle(frame, (x, y), (x + w, y + h), Colors.lime_green, 2)
                    except Exception as error:
                        print("An exception occurred:", error)

                    # Отрисовка информаци на видео - линии, боксы  и данные
                    cv2.rectangle(frame_res, (_x, _y), (_x + _w, _y + _h), Colors.lime_green, 2)
                    cv2.circle(frame_res, (_cx, _cy), 5, Colors.red, -1)
